...
<html>
  ...
  <frameset rows="120,500" cols="*" scrolling="No" framespacing="0" frameborder="no" border="0"> 
	<frame src="views/frame/mhead.jsp" name="headmenu" id="mainFrame" title="mainFrame">
 <frameset rows="100*"  cols="350,*" scrolling="No"
	framespacing="0" frameborder="no" border="0"> 
<frame
	src="views/frame/mleft.jsp" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="views/frame/m2.jsp" name="main" scrolling="yes" noresize="noresize"
